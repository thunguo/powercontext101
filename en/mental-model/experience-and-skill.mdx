...
1. Are Candidate version and Artifact Revision separate?
2. Do propose and generate stop at pending or no-op?
3. Do approve and reject bind the inspected `expected_version`?
4. Does Experience recall use only the approved current head?
5. Does Skill remain outside PreparedContext?
6. Are approval, export, and execution separate?
7. Are Codex and Claude Code the only current export targets listed?
8. Do local drift and conflict prevent overwrite?
