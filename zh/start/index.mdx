...
<Columns cols={2}>
  ...
  <Card title="配置通用 Agent" icon="bot" href="/zh/common-agents/overview" arrow="true" cta="选择通用 Agent">
    按 Hermes、OpenClaw、WorkBuddy 或 Agent Plugin 完成安装、激活和验证。涉及凭证、持久写入和 Review 的动作仍由你授权。
  </Card>
  <Card title="配置编程 Agent" icon="terminal" href="/zh/coding-agents/overview" arrow="true" cta="选择编程 Agent">
    了解 Codex、Claude Code、DSH、OpenCode 和 Pi 如何把同一 Server 合同映射到各自生命周期。
  </Card>
</Columns>
...
- Hermes, OpenClaw, WorkBuddy, and Agent Plugin: `/zh/common-agents/overview`
